...
if "questions" not in st.session_state:
    ...
    st.session_state.username = "User"  # Placeholder if no login system
    st.session_state.logged_in = True  # Placeholder if no login system
